...
## Corpus Check
- 41 files · ~28,541 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 312 nodes · 526 edges · 15 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `396f8154`
...
6. `HANDOFF — Where Are We: canvas reliability pass` - 9 edges
7. `HANDOVER — Where Are We v2 (verification complete, ready to use)` - 9 edges
8. `nodeSize()` - 8 edges
...
- `App()` --calls--> `lodForScale()`  [EXTRACTED]
  src/App.tsx → src/canvas/lod.ts
...
Cohesion: 0.07
Nodes (41): CanvasView(), Drag, EdgeItem, EraseTarget, Props, DrawnPath(), Props, EdgeShape (+33 more)
...
Cohesion: 0.08
Nodes (24): 1. Overview, 2. Colors: Slate and Chalk, 3. Typography, 4. Elevation, 5. Components, 6. Do's and Don'ts, Buttons, Cards / Containers (+16 more)
...
### Community 9 - "Rect"
Cohesion: 0.11
Nodes (40): App(), nowIso(), PRESET_SLOTS, todayStr(), NodeItem, SectionItem, Analysis, analyze() (+32 more)
...
Cohesion: 0.20
Nodes (9): 2026-07-24 canvas reliability pass (HANDOFF-CANVAS-FIX.md), Board state (data/where-are-we.json), Data files in a data dir, Gotchas that still apply, HANDOVER — Where Are We v2 (verification complete, ready to use), Machine setup notes (fresh machine), What this project is, What to do next (nothing is blocked) (+1 more)
...
## Knowledge Gaps
- **136 isolated node(s):** `args`, `cwd`, `dataDir`, `name`, `version` (+131 more)
